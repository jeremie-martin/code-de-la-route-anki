...
Paquet complet SHA-256 : `a10d5308830baf6ac78462924ace25a2dd73232cba7e5b8a959fc22a6302486b`.
...
4372 comparaisons recto/verso : géométrie des images, textes et typographie des prompts (le texte cloze se révèle en place et peut naturellement changer de longueur).

585 faces/configurations nécessitent un défilement vertical ; ce défilement est admis. Captures en pleine hauteur et captures du seul écran (`_viewport`).
