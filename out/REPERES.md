...
**Exemple.** Un feu vert autorise le passage, mais un piéton engagé ou une sortie de carrefour bouchée peut imposer d’attendre. Répondre séparément à « le feu est vert » et « je peux m’engager maintenant ».
...
**Exemple.** Une ligne discontinue permet son franchissement, mais pas un dépassement sans visibilité. Un panonceau de distance annonce où commence le danger ; un panonceau d’étendue indique sa longueur. Une fin de limitation ponctuelle rétablit les règles applicables à la route, pas une vitesse libre.
...
**Exemple.** Avec 15 m pendant la réaction et 25 m de freinage, l’arrêt prend 40 m. Si le freinage double et la réaction reste identique, il faut 65 m, pas 80. Une zone masquée exige une marge même si aucun usager n’est encore visible. Un seuil légal d’alcool ne définit pas une absence de risque.
...
**Exemple.** À un passage à niveau ouvert, une file arrêtée juste après les rails impose d’attendre avant les rails. Dans un tunnel, une niche avec téléphone aide à alerter ; une issue de secours sert à évacuer. Une sortie d’autoroute manquée se rattrape plus loin, jamais par marche arrière.
...
**Exemple.** Pour tourner à droite en traversant une piste cyclable parallèle, vérifier aussi derrière à droite et céder au cycliste concerné. À côté d’un camion, voir un rétroviseur ne prouve pas que son conducteur m’a repéré ; son arrière peut couper l’espace intérieur du virage.
...
**Exemple.** Être assuré au tiers indemnise les dommages causés aux autres, pas automatiquement ma voiture. Une défaillance critique au contrôle technique ne laisse pas les mêmes possibilités qu’une défaillance majeure. Une peine maximale encourue n’est pas une peine automatiquement prononcée.
...
**Exemple.** Une personne inconsciente après un malaise sans traumatisme, qui respire normalement, relève de la PLS et de la surveillance. Une victime qui ne respire pas normalement relève de l’alerte, de la RCP et du DAE. Après un traumatisme, ne pas appliquer mécaniquement la même mobilisation : suivre les secours.
...
**Exemple.** Une portière gauche exige de vérifier derrière à gauche. L’ouverture avec la main opposée facilite la rotation du corps, mais ne remplace pas le regard. Un enfant descend de préférence côté trottoir.
...
**Exemple.** Le témoin de batterie allumé avant le démarrage n’a pas la même portée que s’il apparaît en roulant. Sur une étiquette de pression, lire la bonne ligne de charge et les colonnes avant/arrière. L’ABS évite le blocage des roues ; l’AFU et l’AEB n’ont pas le même déclenchement.
...
**Exemple.** Un siège bébé dos à la route à l’avant exige la désactivation de l’airbag frontal correspondant. Pour le permis B, traiter d’abord le cas d’une remorque de PTAC au plus 750 kg ; au-delà, examiner la somme des PTAC. Alléger la remorque ne change pas le PTAC inscrit sur sa carte grise.
...
**Exemple.** Lever le pied tôt à l’approche d’un feu ménage les freins. Descendre au point mort retire le frein moteur. Éteindre un dégivrage encore nécessaire à la visibilité n’est pas une bonne économie. Une voiture électrique n’émet pas de gaz à l’échappement mais conserve d’autres impacts.

**Transfert.** Distinguer CO₂, polluants de l’air et énergie consommée. Une vignette Crit’Air classe le véhicule ; la règle locale indique s’il peut circuler à cet endroit et à cet horaire.
